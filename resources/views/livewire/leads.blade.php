                        ...
                        @method('PUT')
                            ...
                            <div>
                                ...
                                <input type="date" value={{$lead_edit->lead_date}}
                                    class="w-full px-3 text-black py-2 mt-1 border rounded-lg focus:ring-2 focus:ring-blue-400 transition duration-300" name="lead_date">
                            </div>
                            <div>
                                ...
                                <select name="branch"
                                    ...
                                    <option value="{{ $branch->id }}" {{ $branch->id == $lead_edit->branch ? 'selected' : '' }}>{{ $branch->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="service" id="service"
                                    ...
                                    <option value="">Select Service</option>
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}" {{ $service->id  == $lead_edit->service ? 'selected' : '' }}>{{ $service->name }}</option>
                                    @endforeach
                                </select>
                            </div>
