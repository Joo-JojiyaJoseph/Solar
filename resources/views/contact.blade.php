...
@section('content')
 ...
 <section class="inner-banner">
    <div class="image-layer" style="background-image: url({{ asset('/storage/images/background/banner-image-4.jpg') }});"></div>
...
<section class="contact-page">
    <div class="left-bg"><img src="{{ asset('/storage/images/background/bg-25.png') }}" alt="" title=""></div>
    <div class="right-bg"><img src="{{ asset('/storage/images/background/bg-6.png') }}" alt="" title=""></div>
    <!--location Section-->
                ...
                <div class="row clearfix">
                    ...
                    <div class="contactinfo-block col-lg-4 col-md-4 col-sm-12">
                        <div class="inner-box cp-seprator wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                            <h4>Contact Info</h4>
                            <div class="text">Restaurant <br>Email : booking@domainname.com</div>
    ...
    <div class="auto-container">
        <div class="c-page-form-box">
            ...
            <!--form image Section-->
            <div class="loc-block col-lg-6 col-md-12 col-sm-12">
                <img src="{{ asset('/storage/images/resource/restaurant.png') }}" alt="">
            </div>
            </div>
        </div>
    </div>
