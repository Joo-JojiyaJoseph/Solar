...
class TechnicianController extends Controller
{
    ...
    {
        $technicians = Admin::Orderby('id', 'desc')->where('type','technician')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('technician.index'))->with('success', 'Added Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $filename = time().'.'.$request->file('image')->extension();
            $request->image->storeAs('uploads/technician', $filename, 'public');
            $filename = 'uploads/technician/'.$filename;
        } else {
